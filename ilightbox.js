	...
	iLightBox.prototype = {
		...
		normalizeSocial: function(obj, url){
			...
			$.each(obj, function(key, value) {
				...
				obj[key] = {
					URL: value.URL && absolutizeURI(baseURL, value.URL) || opts.linkId && window.location.href || url && absolutizeURI(baseURL, url),
		...
		repositionPhoto: function(){
			...
			var thumbsOffsetW = (vars.isInFullScreen && opts.fullAlone || vars.isMobile) ? 0 : ((path == 'horizontal') ? 0 : vars.thumbnails.outerWidth()),
				...
				width = (vars.isInFullScreen && opts.fullAlone || vars.isMobile) ? winWidth : (winWidth - (opts.styles.pageOffsetX)),
				height = (vars.isInFullScreen && opts.fullAlone || vars.isMobile) ? winHeight : (winHeight - (opts.styles.pageOffsetY)),
